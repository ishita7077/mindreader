# MindReader — Implementation Plan (FINAL)
...
# Step 5: ONLY THEN install MindReader dependencies
...
python -m tribev2.grids.test_run
```
If this fails, the environment is broken. Fix it before touching MindReader code.
...
1. Landing: two equal text boxes, `MindReader` CTA, clickable examples, methodology link, no marketing sections.
...
1. What MindReader does (2 sentences)
