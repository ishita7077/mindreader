  ...
  const payload = {
    ...
    output_contract: {
      answers: [{
        ...
        likely_driver: "what wording probably moved the signal; concrete, transcript-tied, no vague model language",
        why_it_matters: "what this tells a sales reader about this call/script; observation only, no coaching advice",
